...
// The component is displayed in the modal and displays all the details for the selected player post and allows the creator to select and reject interested users
